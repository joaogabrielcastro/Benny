...
const NAV = [
  ...
  { to: "/ordens-servico", label: "Ordens de serviço", icon: FiTool },
  { to: "/orcamentos", label: "Orçamentos", icon: FiFileText },
  { to: "/agendamentos", label: "Agenda", icon: FiCalendar },
  { to: "/contas-pagar", label: "Contas a pagar", icon: FiDollarSign },
