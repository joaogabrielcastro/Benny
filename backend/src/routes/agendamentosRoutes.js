...
router.get("/hoje/lista", agendamentosController.hojeLista.bind(agendamentosController));
...
router.put("/:id", agendamentosController.atualizar.bind(agendamentosController));
router.delete("/:id", agendamentosController.deletar.bind(agendamentosController));
